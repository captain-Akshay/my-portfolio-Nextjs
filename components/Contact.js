...
export default function Contact() {
  ...
  return (
    <section>
      <div className="max-w-6xl mx-auto h-48 bg-inherit dark:bg-gray-600 antialiased">
        <h1 className=" text-5xl md:text-9xl font-bold py-19 text-center md:text-left">
          Contact
        </h1>
      </div>
      <div className="relative z-10 rounded-md shadow-md bg-inherit dark:bg-gray-600 p-4 md:p-10 lg:p-20 max-w-6xl mx-auto mb-20 -mt-4">
